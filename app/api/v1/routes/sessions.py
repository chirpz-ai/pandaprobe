...
async def get_session(
    ...
    return SessionDetail(
        ...
        total_span_count=int(summary.total_span_count) if summary.total_span_count else 0,
        total_tokens=int(summary.total_tokens) if summary.total_tokens else 0,
...
def _row_to_session_summary(r: Any) -> SessionSummary:
    return SessionSummary(
        ...
        total_span_count=int(r.total_span_count) if r.total_span_count else 0,
