...
export default function DashboardPage() {
    ...
    async function fetchStats() {
      ...
      try {
        const [traces, sessions, monitors, usage] = await Promise.allSettled([
          currentProject ? listTraces({ limit: 1 }) : Promise.resolve(null),
          currentProject ? listSessions({ limit: 1 }) : Promise.resolve(null),
          currentProject ? listMonitors({ limit: 1 }) : Promise.resolve(null),
          getUsage(),
        ]);
  ...
  return (
    <div className="space-y-6 animate-fade-in">
      <h1 className="text-lg font-mono text-primary">Dashboard</h1>
