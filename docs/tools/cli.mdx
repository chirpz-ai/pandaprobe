---
title: "CLI"
description: "Inspect traces, sessions, spans, scores, and evaluation runs from your terminal"
icon: "terminal"
---

The **PandaProbe CLI** is a single binary for interacting PandaProbe API from the terminal:
 list and inspect traces, sessions, and spans; create eval runs or read
...
Creating evaluations and submitting scores (write operations):
...
<Note>
  `evals runs create`, `evals runs batch`, and `evals scores submit` create data. All
  other commands are read-only.
</Note>
