...
<Tabs>
  ...
  <Tab title="npm">
    ```bash
    npm install pandaprobe langchain @langchain/openai @langchain/core
    ```
  </Tab>
  <Tab title="yarn">
    ```bash
    yarn add pandaprobe langchain @langchain/openai @langchain/core
    ```
  </Tab>
  <Tab title="pnpm">
    ```bash
    pnpm add pandaprobe langchain @langchain/openai @langchain/core
    ```
  </Tab>
</Tabs>
